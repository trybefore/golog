...
func (c *logClient) Produce(ctx context.Context, in *ProduceRequest, opts ...grpc.CallOption) (*ProduceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/log.Log/Produce", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *logClient) Consume(ctx context.Context, in *ConsumeRequest, opts ...grpc.CallOption) (*ConsumeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/log.Log/Consume", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *logClient) ConsumeStream(ctx context.Context, in *ConsumeRequest, opts ...grpc.CallOption) (Log_ConsumeStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Log_ServiceDesc.Streams[0], "/log.Log/ConsumeStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *logClient) ProduceStream(ctx context.Context, opts ...grpc.CallOption) (Log_ProduceStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Log_ServiceDesc.Streams[1], "/log.Log/ProduceStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *logClient) GetServers(ctx context.Context, in *ServersRequest, opts ...grpc.CallOption) (*ServersResponse, error) {
	out := new(ServersResponse)
	err := c.cc.Invoke(ctx, "/log.Log/GetServers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedLogServer) GetServers(context.Context, *ServersRequest) (*ServersResponse, error) {
...
func _Log_GetServers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/log.Log/GetServers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LogServer).GetServers(ctx, req.(*ServersRequest))
	}
	return interceptor(ctx, in, info, handler)
}
